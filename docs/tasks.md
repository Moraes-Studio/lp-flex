...
- [ ] **Header** — sticky, nav com âncoras (`#professores`, `#comunidade`, `#planos`, `#modalidades`, `#horarios`, `#sobre`), logo, CTA WhatsApp. Menu mobile (nav desaparece <900px no protótipo — decidir hambúrguer vs. simplificação).
